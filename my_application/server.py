...
def queues_create():
	"""
	Create queue
	curl -X POST -H 'Content-Type: application/json' http://localhost:5000/queues -d '{"name": "AadamLab12"}'
	curl -X POST -H 'Content-Type: application/json' 52.18.184.96:8080/queues -d '{"name": "AadamLab12"}'	
...
def queues_remove(name):
	"""
	Delete queue
	curl -X DELETE -H 'Accept: application/json' http://localhost:5000/queues/AadamLab12
	curl -X DELETE -H 'Accept: application/json' 52.18.184.96:8080/queues/AadamLab12
...
def messages_count(name):
	...
	curl -X GET -H 'Accept: application/json' http://localhost:5000/queues/AadamLab12/msgs/count
	curl -X GET -H 'Accept: application/json' 52.18.184.96:8080/queues/AadamLab12/msgs/count
	"""
...
def messages_write(name):
	...
	curl -s -X POST -H 'Accept: application/json' http://localhost:5000/queues/AadamLab12/msgs -d '{"content": "this is the queue message"}' 
	curl -s -X POST -H 'Accept: application/json' 52.18.184.96:8080/queues/AadamLab12/msgs -d '{"content": "this is the queue message"}'
	"""
...
def messages_read(name):
	...
	curl -X GET -H 'Accept: application/json' http://localhost:5000/queues/AadamLab12/msgs
	curl -X GET -H 'Accept: application/json' 52.18.184.96:8080/queues/AadamLab12/msgs
	"""
...
def messages_consume(name):
	...
	curl -X DELETE -H 'Accept: application/json' http://localhost:5000/queues/AadamLab12/msgs
	curl -X DELETE -H 'Accept: application/json' 52.18.184.96:8080/queues/AadamLab12/msgs
	"""
